...
function HomePage() {
  ...
  return (
    <div className="space-y-16 pb-16 sm:space-y-24 sm:pb-24 text-[#2d241e]">
      {/* ========================= */}
      {/* 1. HERO SECTION */}
      {/* ========================= */}
      <section className="relative overflow-hidden bg-gradient-to-b from-[#f5efe6] via-[#faf7f2] to-[#faf7f2] pt-8 pb-16 sm:pt-14 sm:pb-24 border-b border-[#ebdcca]">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-12 lg:gap-14">
          ...
          <div className="space-y-6 lg:col-span-7">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#d6c6b3] bg-white/90 px-4 py-2 backdrop-blur-xs shadow-xs">
              <Sparkles className="h-4 w-4 text-[#8a735e]" />
            ...
            <h1 className="font-serif text-4xl font-bold leading-[1.18] tracking-tight text-[#3b2d24] sm:text-5xl md:text-6xl lg:text-[64px]">
              {language === "ru" ? (
                <>
                  Уют начинается <br className="hidden sm:inline" />
                  <span className="italic font-normal text-[#8a735e]">с вашего дома</span>
                </>
              ) : (
                <>
                  Qulaylik va shinamlik <br className="hidden sm:inline" />
                  <span className="italic font-normal text-[#8a735e]">uyingizdan boshlanadi</span>
                </>
              )}
            </h1>

            <p className="max-w-xl text-base sm:text-lg lg:text-xl leading-relaxed text-[#5c4a3d] font-normal">
              {language === "ru"
            ...
            <div className="flex flex-col gap-3 pt-2 sm:flex-row sm:items-center sm:gap-4">
              <Link
                to="/catalog"
                className="group flex items-center justify-center gap-2 rounded-full bg-[#3b2d24] px-8 py-4 text-base font-semibold tracking-wide text-white shadow-lg transition-all duration-300 hover:bg-[#271f19] hover:shadow-xl"
              >
              ...
              <Link
                to="/about"
                className="flex items-center justify-center rounded-full border border-[#d6c6b3] bg-white px-7 py-4 text-base font-semibold tracking-wide text-[#3b2d24] transition hover:bg-[#f4efe6]"
              >
            ...
            <div className="grid grid-cols-3 gap-4 border-t border-[#ebdcca] pt-6">
              <div>
                <p className="font-serif text-2xl sm:text-3xl font-bold text-[#3b2d24]">100%</p>
                <p className="text-xs sm:text-sm font-medium text-[#7a6758] mt-1">
                  {language === "ru" ? "Натуральный хлопок" : "Tabiiy paxta matolari"}
                </p>
              </div>
              <div>
                <p className="font-serif text-2xl sm:text-3xl font-bold text-[#3b2d24]">0 so‘m</p>
                <p className="text-xs sm:text-sm font-medium text-[#7a6758] mt-1">
                  {language === "ru" ? "Доставка по Ташкенту" : "Toshkentda bepul yetkazish"}
                </p>
              </div>
              <div>
                <p className="font-serif text-2xl sm:text-3xl font-bold text-[#3b2d24]">Naqd</p>
                <p className="text-xs sm:text-sm font-medium text-[#7a6758] mt-1">
          ...
          <div className="lg:col-span-5">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              <div className="relative aspect-4/5 overflow-hidden rounded-3xl border border-[#ebdcca] bg-[#f4efe6] shadow-2xl sm:rounded-[36px]">
                {heroImage ? (
                  <img
                    src={heroImage}
                  ...
                  <div className="flex h-full flex-col items-center justify-center p-6 text-center">
                    <div className="w-24 h-24 rounded-2xl bg-white p-2 border border-[#dfd2c0] flex items-center justify-center mb-4">
                      <img src="/logo.png" alt="Velmora" className="w-full h-full object-contain" />
                    </div>
                    <p className="font-serif text-3xl font-bold text-[#3b2d24]">
                      VELMORA
                    </p>
                    <p className="text-sm text-[#7a6758] mt-1">Home Textile Collection</p>
                  </div>
                )}

                {/* Floating bottom badge */}
                <div className="absolute inset-x-4 bottom-4 rounded-2xl border border-white/60 bg-white/95 p-4 shadow-lg backdrop-blur-md sm:bottom-6 sm:inset-x-6">
                  <div className="flex items-center justify-between gap-3">
                    <div className="min-w-0">
                      <p className="text-xs font-bold tracking-wider text-[#8a735e] uppercase">
                        {language === "ru" ? "Выбор недели" : "Hafta tanlovi"}
                      </p>
                      <p className="truncate font-serif text-base font-bold text-[#3b2d24]">
                    ...
                    {heroProduct && (
                      <Link
                        ...
                        className="shrink-0 rounded-full bg-[#3b2d24] px-4 py-2 text-xs sm:text-sm font-semibold text-white transition hover:bg-[#271f19]"
                      >
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="mt-1 font-serif text-2xl font-bold tracking-tight text-[#3b2d24] sm:text-3xl lg:text-4xl">
          ...
          <Link
            to="/catalog"
            className="group flex items-center gap-1.5 text-base font-bold text-[#3b2d24] hover:text-[#8a735e]"
          >
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {categories.length > 0 ? (
            categories.slice(0, 3).map((cat, idx) => {
              const bgTones = [
                "from-[#f4efe6] to-[#eae0d1]",
                "from-[#ede6db] to-[#dfd3c2]",
                "from-[#f5eee4] to-[#e8ddcd]",
              ];
              return (
                <Link
                  key={cat.id || idx}
                  to={`/catalog?category=${cat.slug}`}
                  className="group relative flex min-h-[240px] flex-col justify-between overflow-hidden rounded-3xl border border-[#ebdcca] p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl sm:min-h-[280px]"
                >
                  <div
                  ...
                  <div className="relative z-10">
                    ...
                    {cat.description && (
                      <p className="mt-2 line-clamp-2 text-sm text-[#6b584a] leading-relaxed">
                        {cat.description}
                      </p>
                    )}
                  </div>

                  <div className="relative z-10 flex items-center justify-between border-t border-[#d8c8b4]/50 pt-4">
                    <span className="text-sm font-semibold text-[#3b2d24]">
                      {language === "ru" ? "Перейти к товарам" : "Mahsulotlarni ko‘rish"}
                    </span>
                    <span className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-[#3b2d24] shadow-xs transition-transform group-hover:translate-x-1">
            ...
            <>
              <Link
                to="/catalog"
                className="group relative flex min-h-[240px] flex-col justify-between overflow-hidden rounded-3xl bg-gradient-to-br from-[#f4efe6] to-[#eae0d1] p-8 border border-[#ebdcca] shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
              >
                <div>
                  <span className="text-xs font-bold tracking-wider text-[#8a735e] uppercase">
                    Velmora
                  ...
                  <p className="mt-2 text-sm text-[#6b584a]">
                    {language === "ru" ? "Односпальные и двуспальные комплекты" : "1 va 2 kishilik tabiiy matoli to‘plamlar"}
                  </p>
                </div>
                <div className="flex items-center gap-1 text-sm font-bold text-[#3b2d24]">
              ...
              <Link
                to="/catalog"
                className="group relative flex min-h-[240px] flex-col justify-between overflow-hidden rounded-3xl bg-gradient-to-br from-[#ede6db] to-[#dfd3c2] p-8 border border-[#ebdcca] shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
              >
                <div>
                  <span className="text-xs font-bold tracking-wider text-[#8a735e] uppercase">
                    Velmora
              ...
              <Link
                to="/catalog"
                className="group relative flex min-h-[240px] flex-col justify-between overflow-hidden rounded-3xl bg-gradient-to-br from-[#f5eee4] to-[#e8ddcd] p-8 border border-[#ebdcca] shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
              >
                <div>
                  <span className="text-xs font-bold tracking-wider text-[#8a735e] uppercase">
                    Velmora
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <div className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-bold tracking-[0.2em] text-[#8a735e] uppercase">
        ...
        {!loading && !error && products.length === 0 && (
          <div className="mt-8 rounded-3xl border border-[#ebdcca] bg-white p-12 text-center">
            <h3 className="font-serif text-2xl font-bold text-[#3b2d24]">
              {language === "ru" ? "Избранные товары пока не добавлены" : "Hozircha mahsulotlar kutilmoqda"}
            </h3>
            <p className="mt-2 text-base text-[#6b584a]">
              {language === "ru"
            ...
            <Link
              to="/catalog"
              className="mt-6 inline-block rounded-full bg-[#3b2d24] px-8 py-3.5 text-sm font-semibold text-white transition hover:bg-[#271f19]"
            >
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          <div className="flex items-start gap-4 rounded-3xl border border-[#ebdcca] bg-white p-7 shadow-xs transition hover:shadow-md">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[#f4efe6] text-[#8a735e]">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-[#6b584a]">
                {language === "ru"
